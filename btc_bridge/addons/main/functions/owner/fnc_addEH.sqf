...
Description:
    Adds damage and killed event handlers to the player and bridge vehicle to handle clean up when vehicle or player is destroyed.
...
Examples:
    (begin example)
        [_vehicle] call btc_bridge_fnc_addEH_owner;
    (end)
