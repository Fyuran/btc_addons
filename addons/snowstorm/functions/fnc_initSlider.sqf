...
[["%1: initializing module slider %2", __FILE_NAME__, [_ctrlGroup, _ctrlSlider, _ctrlEdit, _ctrlTitle]], 3, "snowstorm"] call EFUNC(tools,debug);
[["%1: _this analysis: _args: %2, _value: %3", __FILE_NAME__, _args, _value], 3, "snowstorm"] call EFUNC(tools,debug);
#endif
