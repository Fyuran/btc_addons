...
/* ----------------------------------------------------------------------------
Function: btc_json_json_fnc_callExtension
...
Examples:
    (begin example)
        [createHashMapFromArray [["function", "retrieveList"], ["path", "."]]] call btc_json_json_fnc_callExtension;
    (end)
...
if(!("function" in _request)) exitWith {
	["'function' property missing"] call BIS_fnc_error;
};
